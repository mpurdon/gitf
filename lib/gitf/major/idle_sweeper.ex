defmodule GiTF.Major.IdleSweeper do
  @moduledoc """
  Autonomous code-quality maintenance agent for the Dark Factory.

  When the factory is idle, the IdleSweeper spawns "passive" janitor missions
  ...
  Distinct from `GiTF.Major.Janitor`, which is the OTP process that runs
  periodic recovery/stall-detection timers for the Major. This module is
  invoked from one of those timers (`:janitor_run`) and decides whether
  the factory has the headroom to take on optional cleanup work.
  """
