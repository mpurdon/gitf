defmodule GiTF.ID do
  ...
  @prefixes ~w(ghost op msn sec cel lnk cst dep cnl mpt src rfi vrf mrp crp erp apr inq prv ckp msc evt agi run gtf fa fl rj qr sp pb skill out llm vrun)a
