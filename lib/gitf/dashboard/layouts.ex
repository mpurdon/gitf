defmodule GiTF.Dashboard.Layouts do
  ...
  # HEEx emits the contents of <style> as raw text, so the sheet is assembled
  # here rather than interpolated in the template. `Surface.base/0` is the half
  # the Catwalk shares with the Console — one palette, one set of scales, one
  # pill — and what follows is the Catwalk's own furniture.
  @own """
  ...
  .subnav a {
  padding: 0.35rem 0.7rem; border-radius: 7px; color: var(--ink-3);
  font-size: 0.82rem; font-weight: 600; text-decoration: none;
  }
  .subnav a:hover { background: var(--panel-2); color: var(--ink-2); text-decoration: none; }
  ...
  .card-label { font-size: 0.8rem; color: var(--ink-3); text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 0.35rem; }
  .card-value { font-size: 1.75rem; font-weight: 700; color: var(--ink); }
  ...
  .badge-grey   { background: var(--line); color: var(--ink-3); }
  ...
  .metric-label { font-size: 0.7rem; color: var(--ink-3); margin-bottom: 0.15rem; }
  .metric-value { font-size: 1rem; font-weight: 600; color: var(--ink-2); }
  ...
  .link_msg-meta { font-size: 0.8rem; color: var(--ink-3); }
  .link_msg-subject { font-weight: 500; color: var(--ink-2); }
  .link_msg-unread .link_msg-subject { color: var(--ink); font-weight: 600; }
  ...
  /* -- Empty state --------------------------------------------------- */
  .empty { color: var(--ink-3); font-style: italic; padding: 1.5rem 0; text-align: center; }
  ...
  .nav-stop-cancel { background: none; color: var(--ink-3); border: 1px solid var(--line); border-radius: 4px; padding: 0.1rem 0.45rem; font-size: 0.7rem; cursor: pointer; margin-left: 0.25rem; }
  .nav-stop-confirm { font-size: 0.7rem; color: var(--crit); margin-left: 0.5rem; display: inline-flex; align-items: center; }
  .nav-stop-result { font-size: 0.7rem; color: var(--ink-3); margin-left: 0.5rem; }
  ...
  .form-label { display: block; font-size: 0.85rem; color: var(--ink-3); margin-bottom: 0.35rem; font-weight: 500; }
  ...
  .step-label { font-size: 0.7rem; margin-top: 0.35rem; color: var(--ink-3); text-align: center; }
  ...
  .step-skipped .step-circle { background: var(--panel-2); color: var(--ink-3); border: 2px dashed var(--line); opacity: 0.5; }
  .step-skipped .step-label { color: var(--ink-3); font-style: italic; opacity: 0.5; }
  ...
  .metadata-grid dt { color: var(--ink-3); font-weight: 500; }
  .metadata-grid dd { color: var(--ink-2); }
  ...
  .plan-card-title { font-weight: 600; color: var(--ink); margin-bottom: 0.5rem; }
  ...
  .section-header { display: flex; align-items: center; gap: 0.5rem; cursor: pointer; padding: 0.6rem 0; border-bottom: 1px solid var(--line-soft); color: var(--ink); font-weight: 600; font-size: 0.9rem; user-select: none; }
  ...
  .issue-low { border-left: 3px solid var(--ink-3); }
  ...
  .override-btn { padding: 0.4rem 1rem; border-radius: 6px; border: 1px solid var(--line); background: var(--line-soft); color: var(--ink-2); cursor: pointer; font-size: 0.85rem; }
  ...
  .component-card { border: 1px solid var(--line-soft); border-radius: 6px; padding: 0.75rem; margin: 0.5rem 0; background: var(--ground); }
  .file-tag { display: inline-block; background: var(--line-soft); padding: 0.15rem 0.5rem; border-radius: 4px; font-family: monospace; font-size: 0.8rem; margin: 0.15rem; }

  /* -- Plan checklist ------------------------------------------------ */
  .checklist-item { display: flex; align-items: center; gap: 0.6rem; padding: 0.65rem 0.85rem; border-bottom: 1px solid var(--line-soft); cursor: pointer; transition: background 0.15s; }
  ...
  .status-icon-pending { color: var(--ink-3); }
  ...
  .criteria-item { display: flex; align-items: flex-start; gap: 0.4rem; padding: 0.2rem 0; font-size: 0.85rem; color: var(--ink-3); }
  ...
  .plan-stat-value { font-size: 1.5rem; font-weight: 700; color: var(--ink); }
  .plan-stat-label { font-size: 0.7rem; color: var(--ink-3); text-transform: uppercase; letter-spacing: 0.05em; margin-top: 0.15rem; }
  .plan-group { background: var(--panel); border: 1px solid var(--line); border-radius: 8px; margin-bottom: 1rem; overflow: hidden; }
  .plan-group-header { display: flex; align-items: center; gap: 0.6rem; padding: 0.75rem 1rem; cursor: pointer; user-select: none; border-bottom: 1px solid var(--line-soft); transition: background 0.15s; }
  .plan-group-header:hover { background: var(--panel-2); }
  .plan-group-title { font-weight: 600; font-size: 0.9rem; color: var(--ink); }
  .plan-group-count { font-size: 0.8rem; color: var(--ink-3); font-weight: 400; }
  ...
  .plan-group-pct { font-size: 0.75rem; color: var(--ink-3); font-family: monospace; min-width: 2.5rem; text-align: right; }
  .plan-detail { padding: 0.85rem 1rem 1rem 2.75rem; border-bottom: 1px solid var(--line-soft); background: var(--ground); }
  ...
  .plan-file-item { font-family: "SF Mono", "Fira Code", monospace; font-size: 0.8rem; color: var(--ink-3); padding: 0.2rem 0; border-left: 2px solid var(--line); padding-left: 0.5rem; margin: 0.15rem 0; }
  .plan-detail-section { margin-bottom: 0.75rem; }
  .plan-detail-section:last-child { margin-bottom: 0; }
  .plan-detail-heading { font-size: 0.75rem; color: var(--ink-3); text-transform: uppercase; letter-spacing: 0.05em; font-weight: 600; margin-bottom: 0.4rem; border-bottom: 1px solid var(--line-soft); padding-bottom: 0.25rem; }

  /* -- Plan description formatting ---------------------------------- */
  .plan-desc { font-size: 0.85rem; color: var(--ink-2); margin-bottom: 0.85rem; line-height: 1.6; }
  .plan-desc-heading { font-weight: 600; color: var(--ink); font-size: 0.9rem; margin-top: 0.75rem; margin-bottom: 0.35rem; padding: 0.35rem 0.6rem; background: var(--line-soft); border-radius: 4px; border-left: 3px solid var(--accent); }
  ...
  .provider-status-unconfigured { color: var(--ink-3); }
  .reorder-btn { background: none; border: 1px solid var(--line); color: var(--ink-3); border-radius: 4px; cursor: pointer; padding: 0.2rem 0.4rem; font-size: 0.85rem; transition: border-color 0.15s, color 0.15s; }
  ...
  .toggle-knob { position: absolute; top: 2px; left: 2px; width: 16px; height: 16px; border-radius: 50%; background: var(--ink-2); transition: transform 0.2s; }
  ...
  .goal-text { color: var(--ink-3); font-size: 0.85rem; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; }
  ...
  .op-card { border-bottom: 1px solid var(--line-soft); padding: 0.6rem 0.75rem; cursor: pointer; transition: background 0.15s; }
  ...
  .sidebar-stat-row:not(:last-child) { border-bottom: 1px solid var(--line-soft); }
  .sidebar-stat-row:hover { background: var(--panel-2); }
  .sidebar-stat-label { color: var(--ink-3); }
  ...
  .triage-detail { font-size: 0.8rem; color: var(--ink-3); margin-top: 0.35rem; white-space: pre-wrap; }
  .triage-rebuttal { font-size: 0.8rem; color: var(--ink-3); margin-top: 0.35rem; padding-left: 0.6rem; border-left: 2px solid var(--ok); white-space: pre-wrap; }
  .triage-tally { font-size: 0.78rem; color: var(--ink-3); font-family: monospace; white-space: nowrap; }
  ...
  def root(assigns) do
    ...
    <html lang="en">
      ...
      <body data-wake-url={@wake_url}>
        ...
        <div id="sleep-banner" hidden style="position:fixed; bottom:1rem; right:1rem; z-index:9000; background:var(--warn-bg); border:1px solid var(--warn); border-radius:6px; padding:0.6rem 0.9rem; font-size:0.85rem; color:var(--ink); box-shadow:var(--shadow); display:flex; gap:0.75rem; align-items:center">
        ...
        <div id="asleep-overlay" hidden style="position:fixed; inset:0; z-index:9500; background:rgba(13,18,24,0.88); display:flex; align-items:center; justify-content:center">
          <div style="background:var(--panel); border:1px solid var(--line-strong); border-radius:8px; padding:1.5rem 1.75rem; max-width:420px; box-shadow:0 8px 24px rgba(0,0,0,0.5); text-align:center">
            ...
            <div style="margin-top:1rem; display:flex; gap:0.5rem; justify-content:center">
              ...
              <code id="asleep-cli" style="font-size:0.8rem; color:var(--ink-2)" hidden>gitf wake</code>
            </div>
          </div>
        </div>
        <div id="shortcuts-help" style="display:none; position:fixed; top:50%; left:50%; transform:translate(-50%,-50%); background:var(--panel); border:1px solid var(--line); border-radius:8px; padding:1.5rem; z-index:10000; max-width:400px; box-shadow:0 8px 24px rgba(0,0,0,0.5)">
          <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:1rem">
            <span style="color:var(--ink); font-weight:600; font-size:1rem">Keyboard Shortcuts</span>
            <span style="color:var(--ink-3); font-size:0.8rem">Press ? to toggle</span>
          </div>
          <div style="display:grid; grid-template-columns:auto 1fr; gap:0.35rem 1rem; font-size:0.85rem">
            <kbd style="background:var(--ground); border:1px solid var(--line); border-radius:3px; padding:0.1rem 0.4rem; font-family:monospace; color:var(--ink-2)">g o</kbd><span style="color:var(--ink-3)">Overview</span>
            <kbd style="background:var(--ground); border:1px solid var(--line); border-radius:3px; padding:0.1rem 0.4rem; font-family:monospace; color:var(--ink-2)">g m</kbd><span style="color:var(--ink-3)">Missions</span>
            <kbd style="background:var(--ground); border:1px solid var(--line); border-radius:3px; padding:0.1rem 0.4rem; font-family:monospace; color:var(--ink-2)">g g</kbd><span style="color:var(--ink-3)">Ghosts</span>
            <kbd style="background:var(--ground); border:1px solid var(--line); border-radius:3px; padding:0.1rem 0.4rem; font-family:monospace; color:var(--ink-2)">g c</kbd><span style="color:var(--ink-3)">Costs</span>
            <kbd style="background:var(--ground); border:1px solid var(--line); border-radius:3px; padding:0.1rem 0.4rem; font-family:monospace; color:var(--ink-2)">g t</kbd><span style="color:var(--ink-3)">Timeline</span>
            <kbd style="background:var(--ground); border:1px solid var(--line); border-radius:3px; padding:0.1rem 0.4rem; font-family:monospace; color:var(--ink-2)">g h</kbd><span style="color:var(--ink-3)">Health</span>
            <kbd style="background:var(--ground); border:1px solid var(--line); border-radius:3px; padding:0.1rem 0.4rem; font-family:monospace; color:var(--ink-2)">g s</kbd><span style="color:var(--ink-3)">Shells</span>
            <kbd style="background:var(--ground); border:1px solid var(--line); border-radius:3px; padding:0.1rem 0.4rem; font-family:monospace; color:var(--ink-2)">g a</kbd><span style="color:var(--ink-3)">Approvals</span>
            <kbd style="background:var(--ground); border:1px solid var(--line); border-radius:3px; padding:0.1rem 0.4rem; font-family:monospace; color:var(--ink-2)">g p</kbd><span style="color:var(--ink-3)">Activity</span>
            <kbd style="background:var(--ground); border:1px solid var(--line); border-radius:3px; padding:0.1rem 0.4rem; font-family:monospace; color:var(--ink-2)">g r</kbd><span style="color:var(--ink-3)">Rollback</span>
            <kbd style="background:var(--ground); border:1px solid var(--line); border-radius:3px; padding:0.1rem 0.4rem; font-family:monospace; color:var(--ink-2)">g q</kbd><span style="color:var(--ink-3)">Merge Queue</span>
          </div>
        </div>
      </body>
    </html>
