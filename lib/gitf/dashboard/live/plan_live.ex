  ...
  def render(assigns) do
    ...
    <div style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:1.25rem; flex-wrap:wrap; gap:0.75rem">
      <div>
        ...
        <div style="color:var(--ink-3); font-size:0.85rem; max-width:700px">{@mission[:goal]}</div>
      </div>
    ...
    <div class="panel" style="margin-bottom:1.25rem; padding:0.85rem 1.25rem">
      <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:0.35rem">
        <span style="font-size:0.85rem; color:var(--ink-3)">Overall Progress</span>
        <span style="font-size:0.85rem; font-weight:600; font-family:monospace; color:var(--ink)">
    ...
    <div :if={length(@lanes) > 0} class="panel" style="margin-bottom:1.25rem; padding:0.85rem 1.25rem">
      <div class="panel-title" style="font-size:0.85rem; margin-bottom:0.75rem; padding-bottom:0.4rem; display:flex; justify-content:space-between; align-items:baseline">
        Execution Lanes
        <span style="font-size:0.68rem; font-weight:400; color:var(--ink-3)">
          ...
          <div style="flex:1; min-width:14rem; display:flex; flex-direction:column; gap:0.5rem">
            ...
            >
              <div style="display:flex; align-items:center; gap:0.4rem">
                <span style="flex:1; font-size:0.8rem; color:var(--ink); line-height:1.3">
              ...
              <div style="display:flex; flex-wrap:wrap; gap:0.3rem; margin-top:0.4rem">
                ...
                <span
                  ...
                  style="font-size:0.62rem; color:var(--ink-3)"
    ...
    <div :if={@mode == :plan_only} class="panel" style="padding:1.5rem; text-align:center; margin-bottom:1rem; color:var(--ink-3)">
        ...
        <div :if={group_open}>
          <div :for={item <- items}>
            ...
            >
              ...
              <span style="flex:1; color:var(--ink); font-size:0.9rem">{Map.get(item, :title) || Map.get(item, "title", "Untitled")}</span>
                ...
                <div :if={has_left}>
                  ...
                  <div :if={deps != []} class="plan-detail-section">
                    ...
                    <div :for={dep <- deps} style="display:flex; align-items:center; gap:0.4rem; padding:0.2rem 0; font-size:0.85rem">
                      ...
                      <span style="color:var(--ink-2)">{dep.title}</span>
                    </div>
                  </div>
                </div>
    ...
    <div :if={@grouped_items == []} class="panel" style="text-align:center; padding:3rem; color:var(--ink-3)">
