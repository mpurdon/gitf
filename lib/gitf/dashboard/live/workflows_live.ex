        ...
        <div class="panel" style="margin-bottom:1.5rem">
          ...
          <form phx-change="update_new" phx-submit="create_workflow">
            <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:0.75rem; margin-bottom:0.75rem">
              <div>
                <label style="display:block; color:var(--ink-3); font-size:0.75rem; margin-bottom:0.25rem; text-transform:uppercase">Name</label>
                <input
                  type="text"
                  name="name"
                  value={@new_name}
                  ...
                  style="width:100%; background:var(--ground); border:1px solid var(--line); color:var(--ink-2); padding:0.4rem 0.6rem; border-radius:4px; font-size:0.85rem"
                />
              </div>
              <div>
                <label style="display:block; color:var(--ink-3); font-size:0.75rem; margin-bottom:0.25rem; text-transform:uppercase">Fork from</label>
                <select
                  name="template"
                  style="width:100%; background:var(--ground); border:1px solid var(--line); color:var(--ink-2); padding:0.4rem 0.6rem; border-radius:4px; font-size:0.85rem"
                >
              ...
              <div>
                <label style="display:block; color:var(--ink-3); font-size:0.75rem; margin-bottom:0.25rem; text-transform:uppercase">Scope</label>
                <select
                  name="sector"
                  style="width:100%; background:var(--ground); border:1px solid var(--line); color:var(--ink-2); padding:0.4rem 0.6rem; border-radius:4px; font-size:0.85rem"
                >
            ...
            <span style="color:var(--ink-3); font-size:0.75rem; margin-left:0.75rem">
      ...
      <div class="panel">
        ...
        <% else %>
          <table style="width:100%; border-collapse:collapse">
            <thead>
              <tr style="text-align:left; color:var(--ink-3); font-size:0.75rem; text-transform:uppercase">
            ...
            <tbody>
              <%= for w <- @workflows do %>
                <tr style="border-bottom:1px solid var(--line)">
                  ...
                  <td style="padding:0.5rem 0.5rem; color:var(--ink-3)">{String.slice(w.description || "", 0, 80)}</td>
                  <td style="padding:0.5rem 0.5rem; color:var(--ink-3); font-size:0.75rem; font-family:monospace">
