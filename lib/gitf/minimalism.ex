defmodule GiTF.Minimalism do
  ...
  defp find_violations(op) do
    ...
    violations =
      if String.contains?(text, ["factory", "builder", "strategy", "adapter", "facade"]) do
    ...
    violations =
      if String.contains?(text, ["framework", "library", "abstraction layer"]) do
