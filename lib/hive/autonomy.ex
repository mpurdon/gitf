defmodule Hive.Autonomy do
  ...
  def predict_issues(comb_id) do
    patterns = Hive.Intelligence.FailureAnalysis.get_failure_patterns(comb_id)
  ...
  defp recover_stuck_jobs do
    ...
    if length(stuck) > 0 do
      Enum.each(stuck, fn job ->
        ...
        Hive.Intelligence.Retry.retry_with_strategy(job.id)
      end)
  ...
  defp collect_metrics do
    ...
    %{
      ...
      cost_trend: Hive.Observability.Metrics.trend(:cost_usd)
    }
  end
